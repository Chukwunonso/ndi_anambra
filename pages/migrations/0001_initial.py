    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('twitter_name', models.URLField(blank=True, help_text='Your Twitter URL', max_length=255, null=True)),
        ...
        migrations.AddField(
            model_name='contentblock',
            name='page',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='contentblocks', to='wagtailcore.Page'),
        ),
        migrations.AddField(
            model_name='advert',
            name='link_page',
